...
- (void)viewDidLoad {
    ...
    } else if ([@"obsidium" isEqualToString:self.theme]) {
        barBgColor = [UIColor colorWithRed:0.11 green:0.11 blue:0.12 alpha:1.0];
        primaryColor = [UIColor colorWithRed:0.36 green:0.61 blue:0.90 alpha:1.0];
